...
if(NOT EXISTS ${CMAKE_CURRENT_BINARY_DIR}/ucd/NormalizationTest.txt)
  ...
  file(DOWNLOAD "https://unicode.org/Public/14.0.0/ucd/NormalizationTest.txt" ${CMAKE_CURRENT_BINARY_DIR}/ucd/NormalizationTest.txt)
endif()
if(NOT EXISTS ${CMAKE_CURRENT_BINARY_DIR}/ucd/GraphemeBreakTest.txt)
  message(STATUS "Fetching unicode tests")
  file(DOWNLOAD "https://unicode.org/Public/14.0.0/ucd/auxiliary/GraphemeBreakTest.txt" ${CMAKE_CURRENT_BINARY_DIR}/ucd/GraphemeBreakTest.txt)
endif()
if(NOT EXISTS ${CMAKE_CURRENT_BINARY_DIR}/ucd/WordBreakTest.txt)
  message(STATUS "Fetching unicode tests")
  file(DOWNLOAD "https://unicode.org/Public/14.0.0/ucd/auxiliary/WordBreakTest.txt" ${CMAKE_CURRENT_BINARY_DIR}/ucd/WordBreakTest.txt)
endif()
if(NOT EXISTS ${CMAKE_CURRENT_BINARY_DIR}/ucd/PropertyValueAliases.txt)
  message(STATUS "Fetching PropertyValueAliases.txt")
  file(DOWNLOAD "https://unicode.org/Public/14.0.0/ucd/PropertyValueAliases.txt" ${CMAKE_CURRENT_BINARY_DIR}/ucd/PropertyValueAliases.txt)
endif()
